                ...
                <div class="app-content">
                    ...
                    <div class="form-parent card-show-parent">
                                ...
                                <div class="card-content">
                                    <div class="card-group form-group">
                                        ...
                                        <input
                                            ...
                                            type="number"
                                            name="dni"
                                            v-model="this.recepcionista.dni"
                                    ...
                                    <div class="card-group form-group">
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            name="nombres"
                                            v-model="this.recepcionista.nombres"
                                            :disabled="!this.statusEdit"
                                            required
                                        />
                                    </div>
                        ...
                        <div class="form">
                            <form
                                class="form-update"
                                v-on:submit.prevent="updateUser(this)"
                            >
                                <div class="card-header">
                                ...
                                <div class="card-content">
                                    <div class="card-group form-group">
                                        ...
                                        <input
                                            ...
                                            type="email"
                                            name="correo"
                                            v-model="this.recepcionista.email"
                                            :disabled="!this.statusEditUser"
                                            required
                                        />
                                    </div>
                                    <div class="card-group form-group">
                                    ...
                                    <div
                                        class="card-group form-group"
                                        v-if="this.statusEditUser"
                                    >
                                    ...
                                    <div class="card-group form-group buttons">
                                        <button
                                            class="raise btn-green"
                                            type="button"
                                            :hidden="this.statusEditUser"
                                            v-on:click="trueEditUser()"
                                        >
                                            Editar campos
                                        </button>
                                        <button
...
export default {
    ...
    created() {
        ...
        axios
            .get(`api/recepcionistas/${this.$route.params.id}`)
            .then((data) => {
    ...
    methods: {
        ...
        correctPassword() {
            return (
                this.recepcionista.password ===
                    this.recepcionista.confirmPassword ||
                (this.recepcionista.password ===
                    this.recepcionista.confirmPassword &&
                    this.recepcionista.password === "")
            );
