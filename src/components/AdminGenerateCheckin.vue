                ...
                <form class="form-update" @submit.prevent="hacerCheckIn">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-group form-group">
                            ...
                            <select class="form-input" v-model="resultadoEscaner.tipo_documento" required>
...
export default {
    ...
    methods: {
        ...
        // Todos los campos obligatorios están completos, realizar alguna acción
        ...
        scanPax() {
        if (this.resultadoEscaner.tipo_documento === 'Dni') {
            ...
            this.mostrarModal();
        } else if (this.resultadoEscaner.tipo_documento === 'Extranjeria') {
        ...
        if (this.resultadoEscaner.tipo_documento === 'Extranjeria') {
            // Lógica cuando el acompañante NO tiene DNI peruano
